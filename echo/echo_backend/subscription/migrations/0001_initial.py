        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan_type', models.CharField(choices=[
                 ('FREE', 'Free'), ('PREMIUM', 'Premium')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('ACTIVE', 'Active'), ('EXPIRED', 'Expired'), (
                    'CANCELLED', 'Cancelled')], default='ACTIVE', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[
                 ('CARD', 'Credit/Debit Card'), ('PAYPAL', 'PayPal'), ('BANK', 'Bank Transfer')], max_length=20)),
                ...
                ('subscription', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT,
                 related_name='payments', to='subscription.subscription')),
            ],
            options={
